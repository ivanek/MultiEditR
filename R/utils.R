...
#'
#' @param sanger_df A \code{tibble} generated by
...
#'   \code{gamlss} models.
#' @return A \code{tibble} containing the fitted ZAGA
...
#' # tibble suitable for the 'sanger_df' argument.
...
#'
#' @param sanger_df A \code{tibble} containing sanger sequencing
...
#' @param critical_values A \code{tibble} of critical values
#'   (though not used in the current function logic, it is
#'   retained for compatibility).
#' @param zaga_parameters A \code{tibble} of fitted ZAGA
...
#' @return A \code{tibble} filtered and augmented with raw
...
#'
#' @param motif_part_of_sample A \code{tibble} containing sanger
...
#' @return The original \code{motif_part_of_sample} \code{tibble}
...
#' object to create a \code{tibble} containing peak area, location, and
...
#' @return A \code{tibble} with one row per base call position, containing:
#'   \itemize{
...
#' results into a single comprehensive \code{tibble} for final output.
#'
...
#'
#' @param editing_data A \code{tibble} containing the intermediate
...
#' @return A summarized \code{tibble} with the following columns:
#'   \itemize{
...
#' @param raw_sample_df A \code{tibble} containing the processed
...
#'   }
#' @importFrom dplyr distinct case_when summarize pull rename mutate arrange filter inner_join ungroup row_number bind_rows
